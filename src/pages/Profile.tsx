...
import logo from '../images/logo/splash_logo.png';
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <img src={user?.profilePic || logo} alt="profile" className='rounded-full'/>
              <label
                htmlFor="profile"
          ...
          <div className="mt-4">
            <h3 className="mb-1.5 text-2xl font-semibold text-black dark:text-white">{user?.name}</h3>
            ...
            {user?.bio_description && (
              <div className="mx-auto max-w-180 mt-4.5">
                ...
                <p className="mt-4.5">{user?.bio_description}</p>
              </div>
            )}
