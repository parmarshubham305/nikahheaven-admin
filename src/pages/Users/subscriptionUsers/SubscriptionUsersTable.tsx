...
const SubscriptionUsersTable: React.FC<matchedUserTable> = ({ data }) => {
  //states
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex gap-x-2 ">
          <DeleteModal row={row} handleDelete={handleDelete} loading={loading} />
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white text-black dark:text-white px-5 pt-4 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      <TableTitle globalFilter={globalFilter} setGlobalFilter={setGlobalFilter} tableName="Subscription Users" />
