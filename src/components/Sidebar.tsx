      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        {/* <div className="flex items-center gap-2 px-6 py-5.5 lg:py-6.5"> */}
          <NavLink to="/" className="flex items-center gap-2">
            ...
            <h1 className='subpixel-antialiased text-2xl font-semibold'>NikahHeaven</h1>
          </NavLink>
        {/* </div> */}
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    UrlStr === '' && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <li>
                <NavLink
                  to="/users"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    UrlStr === 'users' && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg className="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
              ...
              <li>
                <NavLink
                  to="/swiped-users"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('swiped-users') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <IoIosSwitch />
                  Swiped Users
              ...
              <li>
                <NavLink
                  to="/matched-users"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('matched-users') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <GiMatchHead />
                  Match Users
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('subscription-users') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <MdPayment />
                  Subscription Users
              ...
              <li>
                <NavLink
                  to="/seeker-request"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('seeker-request') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <ImFinder />
                  Seeker Request
              ...
              <li>
                <NavLink
                  to="/schedule-meeting"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('schedule-meeting') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <MdSchedule />
                  Schedule Meeting
